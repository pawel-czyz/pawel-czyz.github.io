...
Carl told me recently about a sentence from his [variational classification paper](https://openreview.net/forum?id=EWv9XGOpB3): "*the softmax layer can be interpreted as applying Bayes' rule (...), assuming that the variables follow exponential family class-conditional distributions*".

I very much like this observation, but when I first heard it, I did not understand at all why this is true: isn't that too powerful?

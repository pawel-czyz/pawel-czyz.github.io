...
This is a bit weird: the diagonal terms $\Omega_{gg}$ seem to affect the energy in this model, even though they did not control it in the other parameterisation.

Somewhat here has to be wrong...